...
void runMap()
{
	...
	ft_map.insert(std::make_pair(7, 7));
	ft_map.insert(std::make_pair(3, 3));
	ft_map.insert(std::make_pair(9, 19));
	ft_map.insert(std::make_pair(8, 8));
	ft_map.insert(std::make_pair(8, 1));
	ft_map.insert(std::make_pair(1, 1));
	ft_map.insert(std::make_pair(10, 10));

	std::cout << GREEN_C << "\tDO: use map.value_comp()" << RESET_C << std::endl;
	ft::map<int, int>::iterator it2 = ft_map.begin();
	std::pair<int, int> highest2 = *ft_map.rbegin(); // last element
	do
	{
	...
	std::pair<ft::map<int, int>::iterator, ft::map<int, int>::iterator> ret2;
